...
const createReading = (0, catchAsync_1.default)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const readingData = __rest(req.body, []);
    const data = req.body;
    const finalData = Object.assign(Object.assign({}, data), { status: "running" });
    const result = yield reading_service_1.ReadingService.createReading(finalData);
...
const updateReading = (0, catchAsync_1.default)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const { id } = req.params;
    const result = yield reading_service_1.ReadingService.updateReading(id, req.body);
    (0, sendResponse_1.default)(res, {
        statusCode: http_status_1.default.OK,
        success: true,
